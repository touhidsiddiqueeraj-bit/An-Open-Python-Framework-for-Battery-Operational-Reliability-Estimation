...
| Weibull AFT baseline (N=8,20) | Weibull AFT reaches 0.575 (N=8) and 0.700 (N=20) vs XGBoost 0.995/0.997 — cell-level survival models lack temporal resolution for per-cycle hazard discrimination |
